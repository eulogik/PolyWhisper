"""
Waits for P2 (v4 jet router, pid 58661 / marker in nohup_v5_phase2.log) to finish,
...
P2_LOG = SAVE_DIR / "nohup_v5_phase2.log"
P2_PID_CHECK = "train_router.py --phase 2"
MARKER = "ROUTER TRAINING COMPLETE"
PYTHON = str(Path(".venv/bin/python").absolute())
LAUNCHER_LOG = SAVE_DIR / "nohup_auto_eval_v5.log"
EVAL_LOG = SAVE_DIR / "nohup_eval_v5.log"
...
if __name__ == "__main__":
    ...
    cmd = ["eval_router.py",
           ...
           "--router", str(ADAPTERS / "router_best_v5.pt"),
           "--en-adapter", str(ADAPTERS / "en_router_best_v5.pt"),
           "--hi-adapter", str(ADAPTERS / "hi_router_best_v5.pt"),
           "--beams", "1"]
