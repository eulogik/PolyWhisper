...
\vspace{-1em}
\noindent\small
\textbf{Code:} \url{https://github.com/eulogik/PolyWhisper} \quad
\textbf{Model:} \url{https://huggingface.co/eulogik/polywhisper} \quad
\textbf{PyPI:} \texttt{pip install polywhisper} \quad
\textbf{Web:} \url{https://eulogik.com}
\vspace{0.5em}
