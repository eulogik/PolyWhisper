"""
PolyWhisper v2 Evaluation
LoRA on Whisper Small decoder, uses native generate() with forced prefix.
"""
...
EVAL_FILE = SAVE_DIR / "eval_v2_results.json"
...
for lang in LANGUAGES:
    ...
    if p.exists():
        ...
        loaded.append(lang)
        print(f"  Loaded {lang}: {p.name} ({p.stat().st_size/1024:.0f}KB)")
    else:
...
# ============ EVALUATION ============
print("\n" + "=" * 60)
print("POLYWHISPER V2 EVALUATION")
print("=" * 60)
...
SAMPLES_FILE = SAVE_DIR / "eval_v2_samples.json"
